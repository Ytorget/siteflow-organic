      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
          ...
          <div className="p-4 group">
            ...
            <div className="text-sm text-slate-400 uppercase tracking-widest font-medium">Lägre infrastrukturkostnad</div>
          </div>
          ...
          <div className="p-4 group">
            ...
            <div className="h-1 w-12 bg-slate-800 mx-auto mb-4"></div>
            <div className="text-sm text-slate-400 uppercase tracking-widest font-medium">Historisk uptime</div>
          </div>
          ...
          <div className="p-4 group">
            ...
            <div className="h-1 w-12 bg-slate-800 mx-auto mb-4"></div>
            <div className="text-sm text-slate-400 uppercase tracking-widest font-medium">Användare per server</div>
          </div>
          ...
          <div className="p-4 group">
            ...
            <div className="h-1 w-12 bg-slate-800 mx-auto mb-4"></div>
            <div className="text-sm text-slate-400 uppercase tracking-widest font-medium">Gömda avgifter</div>
          </div>
