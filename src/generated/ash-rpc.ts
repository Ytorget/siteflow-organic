...
export type ProjectResourceSchema = {
  __type: "Resource";
  __primitiveFields: "id" | "name" | "description" | "state" | "budget" | "spent" | "startDate" | "targetEndDate" | "actualEndDate" | "approvedAt" | "rejectionReason" | "cancellationReason" | "isPriority" | "previewUrl" | "previewNotes" | "previewUpdatedAt" | "isDelivered" | "deliveredAt" | "deliveryUrl" | "deliveryNotes" | "customerRating" | "customerReview" | "reviewedAt" | "supportStartDate" | "supportEndDate" | "supportMonths" | "companyId";
  id: UUID;
  name: string;
  ...
  previewUpdatedAt: UtcDateTime | null;
  isDelivered: boolean;
  ...
  supportStartDate: AshDate | null;
  supportEndDate: AshDate | null;
...
export type TicketResourceSchema = {
  __type: "Resource";
  __primitiveFields: "id" | "title" | "description" | "state" | "priority" | "category" | "reviewNotes" | "resolvedAt" | "slaResponseHours" | "slaResolutionHours" | "firstResponseAt" | "slaResponseDueAt" | "slaResolutionDueAt" | "slaResponseBreached" | "slaResolutionBreached" | "projectId" | "reporterId" | "assigneeId";
  id: UUID;
  title: string;
  description: string | null;
  ...
  firstResponseAt: UtcDateTime | null;
  slaResponseDueAt: UtcDateTime | null;
  slaResolutionDueAt: UtcDateTime | null;
...
export type DocumentResourceSchema = {
  __type: "Resource";
  __primitiveFields: "id" | "name" | "description" | "filePath" | "fileSize" | "mimeType" | "category" | "version" | "isLatest" | "projectId" | "ticketId" | "uploadedById" | "parentDocumentId";
  id: UUID;
  name: string;
  description: string | null;
  filePath: string;
  ...
  parentDocument: { __type: "Relationship"; __resource: DocumentResourceSchema | null; };
  versions: { __type: "Relationship"; __array: true; __resource: DocumentResourceSchema; };
};
...
export type ProductPlanResourceSchema = {
  __type: "Resource";
  __primitiveFields: "id" | "title" | "content" | "summary" | "pdfUrl" | "version" | "status" | "sentAt" | "viewedAt" | "approvedAt" | "rejectedAt" | "customerFeedback" | "changeRequests" | "metadata" | "projectId" | "createdById" | "approvedById" | "state" | "isPendingCustomerAction" | "isApproved" | "needsAdminAction" | "daysSinceSent";
  id: UUID;
  title: string;
  content: string;
  summary: string | null;
  ...
  state: "draft" | "revised" | "sent" | "viewed" | "approved" | "changes_requested" | "archived";
...
export type DocumentFilterInput = {
  ...
  parentDocument?: DocumentFilterInput;

  versions?: DocumentFilterInput;
...
export type ProductPlanFilterInput = {
  ...
  state?: {
    eq?: "draft" | "revised" | "sent" | "viewed" | "approved" | "changes_requested" | "archived";
    notEq?: "draft" | "revised" | "sent" | "viewed" | "approved" | "changes_requested" | "archived";
    in?: Array<"draft" | "revised" | "sent" | "viewed" | "approved" | "changes_requested" | "archived">;
  };
...
export type ProjectMarkDeliveredInput = {
  deliveryUrl?: string | null;
  deliveryNotes?: string | null;
  supportMonths?: number | null;
};

export type ProjectMarkDeliveredFields = UnifiedFieldSelection<ProjectResourceSchema>[];

export type InferProjectMarkDeliveredResult<
  Fields extends ProjectMarkDeliveredFields | undefined,
> = InferResult<ProjectResourceSchema, Fields>;

export type ProjectMarkDeliveredResult<Fields extends ProjectMarkDeliveredFields | undefined = undefined> = | { success: true; data: InferProjectMarkDeliveredResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

export async function projectMarkDelivered<Fields extends ProjectMarkDeliveredFields | undefined = undefined>(
  config: {
  primaryKey: UUID;
  input?: ProjectMarkDeliveredInput;
  fields?: Fields;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  customFetch?: (input: RequestInfo | URL, init?: RequestInit) => Promise<Response>;
}
): Promise<ProjectMarkDeliveredResult<Fields extends undefined ? [] : Fields>> {
  const payload = {
    action: "project_mark_delivered",
    primaryKey: config.primaryKey,
    input: config.input,
    ...(config.fields !== undefined && { fields: config.fields })
  };

  return executeActionRpcRequest<ProjectMarkDeliveredResult<Fields extends undefined ? [] : Fields>>(
    payload,
    config
  );
}
...
export type ProjectSubmitReviewInput = {
  customerRating?: number | null;
  customerReview?: string | null;
};

export type ProjectSubmitReviewFields = UnifiedFieldSelection<ProjectResourceSchema>[];

export type InferProjectSubmitReviewResult<
  Fields extends ProjectSubmitReviewFields | undefined,
> = InferResult<ProjectResourceSchema, Fields>;

export type ProjectSubmitReviewResult<Fields extends ProjectSubmitReviewFields | undefined = undefined> = | { success: true; data: InferProjectSubmitReviewResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

export async function projectSubmitReview<Fields extends ProjectSubmitReviewFields | undefined = undefined>(
  config: {
  primaryKey: UUID;
  input?: ProjectSubmitReviewInput;
  fields?: Fields;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  customFetch?: (input: RequestInfo | URL, init?: RequestInit) => Promise<Response>;
}
): Promise<ProjectSubmitReviewResult<Fields extends undefined ? [] : Fields>> {
  const payload = {
  ...
  return executeActionRpcRequest<ProjectSubmitReviewResult<Fields extends undefined ? [] : Fields>>(
    payload,
    config
  );
}
...
export type CommentByTicketInput = {
  ticketId: UUID;
};

export type CommentByTicketFields = UnifiedFieldSelection<CommentResourceSchema>[];
export type InferCommentByTicketResult<
  Fields extends CommentByTicketFields,
> = Array<InferResult<CommentResourceSchema, Fields>>;

export type CommentByTicketResult<Fields extends CommentByTicketFields> = | { success: true; data: InferCommentByTicketResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

export async function commentByTicket<Fields extends CommentByTicketFields>(
  config: {
  input: CommentByTicketInput;
  fields: Fields;
  filter?: CommentFilterInput;
  sort?: string;
  headers?: Record<string, string>;
...
): Promise<CommentByTicketResult<Fields>> {
  const payload = {
    action: "comment_by_ticket",
    input: config.input,
    ...(config.fields !== undefined && { fields: config.fields }),
    ...(config.filter && { filter: config.filter }),
    ...(config.sort && { sort: config.sort })
  ...
  return executeActionRpcRequest<CommentByTicketResult<Fields>>(
    payload,
    config
  );
}
...
export type DocumentByProjectInput = {
  projectId: UUID;
};

export type DocumentByProjectFields = UnifiedFieldSelection<DocumentResourceSchema>[];
export type InferDocumentByProjectResult<
  Fields extends DocumentByProjectFields,
> = Array<InferResult<DocumentResourceSchema, Fields>>;

export type DocumentByProjectResult<Fields extends DocumentByProjectFields> = | { success: true; data: InferDocumentByProjectResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

export async function documentByProject<Fields extends DocumentByProjectFields>(
  config: {
  input: DocumentByProjectInput;
  fields: Fields;
  filter?: DocumentFilterInput;
  sort?: string;
  headers?: Record<string, string>;
...
): Promise<DocumentByProjectResult<Fields>> {
  const payload = {
    action: "document_by_project",
    input: config.input,
    ...(config.fields !== undefined && { fields: config.fields }),
    ...(config.filter && { filter: config.filter }),
    ...(config.sort && { sort: config.sort })
  ...
  return executeActionRpcRequest<DocumentByProjectResult<Fields>>(
    payload,
    config
  );
}
...
export type DocumentByTicketInput = {
  ticketId: UUID;
};

export type DocumentByTicketFields = UnifiedFieldSelection<DocumentResourceSchema>[];
export type InferDocumentByTicketResult<
  Fields extends DocumentByTicketFields,
> = Array<InferResult<DocumentResourceSchema, Fields>>;

export type DocumentByTicketResult<Fields extends DocumentByTicketFields> = | { success: true; data: InferDocumentByTicketResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

export async function documentByTicket<Fields extends DocumentByTicketFields>(
  config: {
  input: DocumentByTicketInput;
  fields: Fields;
  filter?: DocumentFilterInput;
  sort?: string;
  headers?: Record<string, string>;
...
): Promise<DocumentByTicketResult<Fields>> {
  const payload = {
    action: "document_by_ticket",
    input: config.input,
    ...(config.fields !== undefined && { fields: config.fields }),
    ...(config.filter && { filter: config.filter }),
    ...(config.sort && { sort: config.sort })
  ...
  return executeActionRpcRequest<DocumentByTicketResult<Fields>>(
    payload,
    config
  );
}
...
export type DocumentByCategoryInput = {
  category: string;
};

export type DocumentByCategoryFields = UnifiedFieldSelection<DocumentResourceSchema>[];
export type InferDocumentByCategoryResult<
  Fields extends DocumentByCategoryFields,
> = Array<InferResult<DocumentResourceSchema, Fields>>;

export type DocumentByCategoryResult<Fields extends DocumentByCategoryFields> = | { success: true; data: InferDocumentByCategoryResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

export async function documentByCategory<Fields extends DocumentByCategoryFields>(
  config: {
  input: DocumentByCategoryInput;
  fields: Fields;
  filter?: DocumentFilterInput;
  sort?: string;
  headers?: Record<string, string>;
...
): Promise<DocumentByCategoryResult<Fields>> {
  const payload = {
    action: "document_by_category",
    input: config.input,
    ...(config.fields !== undefined && { fields: config.fields }),
    ...(config.filter && { filter: config.filter }),
    ...(config.sort && { sort: config.sort })
  ...
  return executeActionRpcRequest<DocumentByCategoryResult<Fields>>(
    payload,
    config
  );
}
...
export type DocumentVersionHistoryInput = {
  documentId: UUID;
};

export type DocumentVersionHistoryFields = UnifiedFieldSelection<DocumentResourceSchema>[];
export type InferDocumentVersionHistoryResult<
  Fields extends DocumentVersionHistoryFields,
> = Array<InferResult<DocumentResourceSchema, Fields>>;

export type DocumentVersionHistoryResult<Fields extends DocumentVersionHistoryFields> = | { success: true; data: InferDocumentVersionHistoryResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

export async function documentVersionHistory<Fields extends DocumentVersionHistoryFields>(
  config: {
  input: DocumentVersionHistoryInput;
  fields: Fields;
  filter?: DocumentFilterInput;
  sort?: string;
  headers?: Record<string, string>;
...
): Promise<DocumentVersionHistoryResult<Fields>> {
  const payload = {
  ...
  return executeActionRpcRequest<DocumentVersionHistoryResult<Fields>>(
    payload,
    config
  );
}
...
export type DocumentLatestOnlyFields = UnifiedFieldSelection<DocumentResourceSchema>[];
export type InferDocumentLatestOnlyResult<
  Fields extends DocumentLatestOnlyFields,
> = Array<InferResult<DocumentResourceSchema, Fields>>;

export type DocumentLatestOnlyResult<Fields extends DocumentLatestOnlyFields> = | { success: true; data: InferDocumentLatestOnlyResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

export async function documentLatestOnly<Fields extends DocumentLatestOnlyFields>(
  config: {
  fields: Fields;
  filter?: DocumentFilterInput;
  sort?: string;
...
): Promise<DocumentLatestOnlyResult<Fields>> {
  const payload = {
    action: "document_latest_only",
    ...(config.fields !== undefined && { fields: config.fields }),
    ...(config.filter && { filter: config.filter }),
    ...(config.sort && { sort: config.sort })
  };

  return executeActionRpcRequest<DocumentLatestOnlyResult<Fields>>(
    payload,
    config
  );
}
...
export type DocumentCreateNewVersionInput = {
  name: string;
  description?: string | null;
  filePath: string;
  fileSize?: number | null;
...
export type DocumentCreateNewVersionFields = UnifiedFieldSelection<DocumentResourceSchema>[];

export type InferDocumentCreateNewVersionResult<
  Fields extends DocumentCreateNewVersionFields | undefined,
> = InferResult<DocumentResourceSchema, Fields>;

export type DocumentCreateNewVersionResult<Fields extends DocumentCreateNewVersionFields | undefined = undefined> = | { success: true; data: InferDocumentCreateNewVersionResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

export async function documentCreateNewVersion<Fields extends DocumentCreateNewVersionFields | undefined = undefined>(
  config: {
  input: DocumentCreateNewVersionInput;
  fields?: Fields;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  customFetch?: (input: RequestInfo | URL, init?: RequestInit) => Promise<Response>;
}
): Promise<DocumentCreateNewVersionResult<Fields extends undefined ? [] : Fields>> {
  const payload = {
    action: "document_create_new_version",
    input: config.input,
    ...(config.fields !== undefined && { fields: config.fields })
  };

  return executeActionRpcRequest<DocumentCreateNewVersionResult<Fields extends undefined ? [] : Fields>>(
    payload,
    config
  );
}
